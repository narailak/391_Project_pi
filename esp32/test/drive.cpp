// =========================== main.cpp (ESP32 + micro-ROS, Differential, fixed pins) ===========================
#include <Arduino.h>
#include <Wire.h>
#include <cmath>
...
static inline void smartPinMode(int pin){
  // GPIO 34..39 = input-only ไม่มี PULLUP ภายใน
...
void setup(){
  ...
  Serial.println("ESP32 Differential + micro-ROS: /man/cmd_move -> encoders out");
}
