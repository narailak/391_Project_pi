...
#define TB_AIN1   19    // เปลี่ยนตามการต่อจริง
#define TB_AIN2   21    // เปลี่ยนตามการต่อจริง
#define TB_PWMA   22    // PWM pin (ESP32 LEDC)
#define TB_STBY   5    // STBY (HIGH = enable). ถ้าไม่ใช้ สามารถผูกกับ VCC ผ่าน R ได้
