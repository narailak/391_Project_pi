...
def generate_launch_description():
    ...
    servo_switch180_node = Node(
        package='servo_switch180_controller',
        executable='servo_switch180_node', 
        name='servo_switch180_node',
        output='screen'
    )

    return LaunchDescription([
        joy_device_arg, joy_autorepeat_arg, joy_deadzone_arg,
        joy_driver_node, servo_switch180_node
    ])
